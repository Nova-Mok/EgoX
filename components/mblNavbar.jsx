				...
				<ul className="flex flex-col lg:flex-row">
					...
					<li className="js-nav-dropdown group relative">
						<button
							...
							onClick={(e) => handleItemDropdown(e)}
						>
							<span className={navText === 'pages' ? 'text-accent' : ''}>Stats</span>
					...
					>
						...
						<div className="dark:border-jacarta-600 border-jacarta-100 mx-5 mb-6 rounded-lg border p-4">
							...
							<div className="flex items-center">
								<svg className="icon icon-ETH -ml-1 mr-1 h-[1.25rem] w-[1.125rem]">
									<use xlinkHref="/avaxicon.svg#avax-icono"></use>
								</svg>
								<span className="text-green text-lg font-bold">10 AVAX</span>
							</div>
						</div>
